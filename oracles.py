...
# class Dolly_Bool_Oracle(Oracle):
#     def __init__(
#         self,
#         model_size,
#         batch_size,
...
#         self.batch_size = batch_size
#         self.model_size = model_size
#         self.model_name = f"databricks/dolly-v2-{self.model_size}"
#         self.tk = AutoTokenizer.from_pretrained(
#             self.model_name,
...
#         )
#         self.model = AutoModelForCausalLM.from_pretrained(
#             self.model_name, cache_dir="./.model_cache", torch_dtype=torch.bfloat16
#         ).cuda()
#         self.model.eval()
...
#             #     input_strs, return_tensors="pt", padding=True
#             # ).input_ids.cuda()
#             tokenized_input = self.tk(input_strs, return_tensors="pt", padding=True)
