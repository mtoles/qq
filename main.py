...
@click.option(
    "--results_file", default=None, help="path to results file. Appended to if exists."
)
def main(
    pt_dataset_path, pm_paths, pm_arch, masking_scheme, downsample_pt_size, results_file
):
    ...
    for model_num, pm_path in enumerate(pm_paths):
        ...
        # pt_dataset = drop_unanswerable(
        # pt_dataset, masking_scheme=masking_scheme, load_from_cache_file=True
        # )
