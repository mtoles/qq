...
## llama3
## p3 works best
# python3 main.py --split train --m1_arch t5-base --m2_arch llama3 --template_id p1 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/llama3 --downsample_pt_size 400 
# python3 main.py --split train --m1_arch t5-base --m2_arch llama3 --template_id p2 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/llama3 --downsample_pt_size 400 
# python3 main.py --split train --m1_arch t5-base --m2_arch llama3 --template_id p3 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/llama3 --downsample_pt_size 400 
# python3 main.py --split train --m1_arch t5-base --m2_arch llama3 --template_id p4 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/llama3 --downsample_pt_size 400 
# python3 main.py --split train --m1_arch t5-base --m2_arch llama3 --template_id p5 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/llama3 --downsample_pt_size 400 
# python3 main.py --split train --m1_arch t5-base --m2_arch llama3 --template_id p6 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/llama3 --downsample_pt_size 400 
