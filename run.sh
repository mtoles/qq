...
## alpaca
## p2 works best
# python3 main.py --m1_eval_batch_size 64 --oracle_eval_batch_size 16 --split train --m1_arch t5-base --m2_arch alpaca --template_id p1 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/alpaca --downsample_pt_size 400 
# python3 main.py --m1_eval_batch_size 64 --oracle_eval_batch_size 16 --split train --m1_arch t5-base --m2_arch alpaca --template_id p2 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/alpaca --downsample_pt_size 400 
# python3 main.py --m1_eval_batch_size 64 --oracle_eval_batch_size 16 --split train --m1_arch t5-base --m2_arch alpaca --template_id p3 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/alpaca --downsample_pt_size 400 
# python3 main.py --m1_eval_batch_size 64 --oracle_eval_batch_size 16 --split train --m1_arch t5-base --m2_arch alpaca --template_id p4 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/alpaca --downsample_pt_size 400 
# python3 main.py --m1_eval_batch_size 64 --oracle_eval_batch_size 16 --split train --m1_arch t5-base --m2_arch alpaca --template_id p5 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/alpaca --downsample_pt_size 400 
# python3 main.py --m1_eval_batch_size 64 --oracle_eval_batch_size 16 --split train --m1_arch t5-base --m2_arch alpaca --template_id p6 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/prompt/alpaca --downsample_pt_size 400 
...
# python3 main.py --m1_eval_batch_size 64 --oracle_eval_batch_size 16 --m1_arch t5-base --m2_arch alpaca --template_id p3 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/main/
...
# python3 main.py --m1_eval_batch_size 64 --oracle_eval_batch_size 16 --m1_arch t5-base --m2_arch alpaca --template_id p3 --oracle_arch t5 --oracle_size base --save_dir results/1_paper/gt/ --gt_subset
